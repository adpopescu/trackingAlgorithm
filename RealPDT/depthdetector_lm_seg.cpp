...
DepthDetector_LM_Seg::DepthDetector_LM_Seg()
{
}

Vector<Vector<double> > DepthDetector_LM_Seg::EvaluateTemplate(const Matrix<double> &upper_body_template, const Matrix<double> &depth_map, Vector<Vector<double> > &close_range_BBoxes, Vector<Vector<double> > distances)
{
